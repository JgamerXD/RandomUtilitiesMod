package com.github.JgamerXD.RandomUtilitiesMod.entities;

import com.github.JgamerXD.RandomUtilitiesMod.modifiers.IEntityModified;
...
/**
 * Created by JgamerXD on 06.08.2014.
 */
public class EntityModifiedArrow extends Entity implements IProjectile, IEntityModified {
    ...
    public EntityModifiedArrow(World par1World) {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
        this.setSize(0.5F, 0.5F);
    }

    public EntityModifiedArrow(World par1World, double par2, double par4, double par6) {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
        this.setSize(0.5F, 0.5F);
    ...
    public EntityModifiedArrow(World par1World, EntityLivingBase par2EntityLivingBase, EntityLivingBase par3EntityLivingBase, float par4, float par5) {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
    ...
    public EntityModifiedArrow(World par1World, EntityLivingBase par2EntityLivingBase, float par3) {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
        this.shootingEntity = par2EntityLivingBase;
    ...
    /*public void onUpdate() {
        ...
        if (var16.getMaterial() != Material.air) {
            ...
            if (var2 != null && !this.worldObj.isAirBlock((int)this.posX, (int)this.posY, (int)this.posZ)) {
                this.inGround = true;
            }
        }
        ...
        if (this.inGround) {
            ...
            var17 = this.worldObj.getVector(this.posX, this.posY, this.posZ);
            ...
            if (var4 != null) {
                if (var4.entityHit != null) {
                    ...
                    if (this.shootingEntity == null) {
                        var21 = DamageSource.causeIndirectMagicDamage(var4.entityHit, this.shootingEntity);
                    } else {
                        var21 = DamageSource.generic;
                    }
