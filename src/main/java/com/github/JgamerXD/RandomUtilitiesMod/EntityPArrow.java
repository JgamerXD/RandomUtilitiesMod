...
//            this.doBlockCollisions();
    ...
    {
    	if (RandomUtilitiesMod.Items.ItemPBow.getDamage().getItemDamage() != 0)
        {
            par1NBTTagCompound.setTag("Potion", RandomUtilitiesMod.Items.ItemPBow.getDamage().writeToNBT(new NBTTagCompound()));
        }
    ...
    public void onCollideWithPlayer(EntityPlayer par1EntityPlayer)
    {
        if (!this.worldObj.isRemote && this.inGround && this.arrowShake <= 0)
        {
            ...
            if (this.canBePickedUp == 1 && !par1EntityPlayer.inventory.addItemStackToInventory(new ItemStack(RandomUtilitiesMod.RandomUtilitiesMod.potionArrow, 1)))
            {
                var2 = false;
            }
