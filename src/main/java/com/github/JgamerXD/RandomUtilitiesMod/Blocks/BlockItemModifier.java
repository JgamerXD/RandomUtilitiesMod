...
public class BlockItemModifier extends BlockContainer implements ITileEntityProvider{
...
//    }
    ...
    {
        this.blockIcon = par1IconRegister.registerIcon(RandomUtilitiesMod.modid+":"+"modifier_side");
        //this.modifierIconFront = par1IconRegister.registerIcon("modifier_front");
        this.modifierIconTop = par1IconRegister.registerIcon(RandomUtilitiesMod.modid+":"+"modifier_top");
    }
...
//    }
    ...
    public void onBlockPlacedBy(World par1World, int par2, int par3, int par4, EntityLivingBase par5EntityLivingBase, ItemStack par6ItemStack)
    {
        ...
        {
            ((TileEntityItemModifier)par1World.getTileEntity(par2, par3, par4)).setInventoryName(par6ItemStack.getDisplayName());
        }
    }
